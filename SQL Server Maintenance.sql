/*  
	...
	Date of last update:
	 v2.0.4 - 01.07.2020 - Ola's stuff updated to the latest version from 26 Jan 2020
...
SET NOCOUNT ON
GO
DECLARE @ScriptVersion			NVARCHAR(16) = '2.0.4'
...
SET @NotifyApplog			= 'N'			-- write notification to APPLOG when job fails Y/N
